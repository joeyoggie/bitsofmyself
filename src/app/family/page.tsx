...
const FAMILY = [
  ...
  { id: 'nehad', name: 'Nehad', role: 'Family Operations', initials: 'N', color: 'from-teal-500/30 to-teal-950', stats: { intelligence: 80, chaos: 91, dadEnergy: 88, snackDetection: 74 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Nehad is registered in the Family Intelligence System as Family Operations.' },
  { id: 'nannoo', name: 'Nannoo', role: 'Family Intelligence', initials: 'N', color: 'from-emerald-500/30 to-emerald-950', stats: { intelligence: 87, chaos: 43, dadEnergy: 99, snackDetection: 91 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Nannoo is registered in the Family Intelligence System as Family Intelligence.' },
  { id: 'omar-cousin', name: 'Omar', role: 'Cousin Systems', initials: 'O', color: 'from-violet-500/30 to-violet-950', stats: { intelligence: 94, chaos: 56, dadEnergy: 54, snackDetection: 72 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Omar is registered in the Family Intelligence System as Cousin Systems.' },
  { id: 'bobba', name: 'Bobba', role: 'Family Operations', initials: 'B', color: 'from-sky-500/30 to-sky-950', stats: { intelligence: 80, chaos: 69, dadEnergy: 65, snackDetection: 89 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Bobba is registered in the Family Intelligence System as Family Operations.' },
  { id: 'rasha', name: 'Rasha', role: 'Family Intelligence', initials: 'R', color: 'from-amber-500/30 to-amber-950', stats: { intelligence: 87, chaos: 82, dadEnergy: 76, snackDetection: 70 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Rasha is registered in the Family Intelligence System as Family Intelligence.' },
  { id: 'spider', name: 'Spider', role: 'External Systems', initials: 'S', color: 'from-pink-500/30 to-pink-950', stats: { intelligence: 94, chaos: 95, dadEnergy: 87, snackDetection: 87 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Spider is registered in the Family Intelligence System as External Systems.' },
  { id: 'reham', name: 'Reham', role: 'Family Intelligence', initials: 'R', color: 'from-cyan-500/30 to-cyan-950', stats: { intelligence: 80, chaos: 47, dadEnergy: 98, snackDetection: 68 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Reham is registered in the Family Intelligence System as Family Intelligence.' },
  ...
  { id: 'ella', name: 'Ella', role: 'Junior Systems', initials: 'E', color: 'from-orange-500/30 to-orange-950', stats: { intelligence: 94, chaos: 73, dadEnergy: 64, snackDetection: 66 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Ella is registered in the Family Intelligence System as Junior Systems.' },
  { id: 'mia', name: 'Mia', role: 'Junior Systems', initials: 'M', color: 'from-indigo-500/30 to-indigo-950', stats: { intelligence: 80, chaos: 86, dadEnergy: 75, snackDetection: 83 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Mia is registered in the Family Intelligence System as Junior Systems.' },
  { id: 'lilly', name: 'Lilly', role: 'Junior Systems', initials: 'L', color: 'from-teal-500/30 to-teal-950', stats: { intelligence: 87, chaos: 38, dadEnergy: 86, snackDetection: 100 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Lilly is registered in the Family Intelligence System as Junior Systems.' },
  { id: 'zio', name: 'Zio', role: 'Junior Systems', initials: 'Z', color: 'from-emerald-500/30 to-emerald-950', stats: { intelligence: 94, chaos: 51, dadEnergy: 97, snackDetection: 81 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Zio is registered in the Family Intelligence System as Junior Systems.' },
  ...
  { id: 'sarah', name: 'Sarah', role: 'Family Systems', initials: 'S', color: 'from-sky-500/30 to-sky-950', stats: { intelligence: 87, chaos: 77, dadEnergy: 63, snackDetection: 79 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Sarah is registered in the Family Intelligence System as Family Systems.' },
  { id: 'youssy', name: 'Youssy', role: 'Junior Systems', initials: 'Y', color: 'from-amber-500/30 to-amber-950', stats: { intelligence: 94, chaos: 90, dadEnergy: 74, snackDetection: 96 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Youssy is registered in the Family Intelligence System as Junior Systems.' },
  { id: 'malek', name: 'Malek', role: 'Junior Systems', initials: 'M', color: 'from-pink-500/30 to-pink-950', stats: { intelligence: 80, chaos: 42, dadEnergy: 85, snackDetection: 77 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Malek is registered in the Family Intelligence System as Junior Systems.' },
  ...
  { id: 'silo', name: 'Silo', role: 'Junior Systems', initials: 'S', color: 'from-teal-500/30 to-teal-950', stats: { intelligence: 94, chaos: 46, dadEnergy: 84, snackDetection: 90 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Silo is registered in the Family Intelligence System as Junior Systems.' },
  { id: 'maya', name: 'Maya', role: 'Junior Systems', initials: 'M', color: 'from-emerald-500/30 to-emerald-950', stats: { intelligence: 80, chaos: 59, dadEnergy: 95, snackDetection: 71 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Maya is registered in the Family Intelligence System as Junior Systems.' },
  ...
  { id: 'mizo', name: 'Mizo', role: 'Family Intelligence', initials: 'M', color: 'from-sky-500/30 to-sky-950', stats: { intelligence: 94, chaos: 85, dadEnergy: 61, snackDetection: 69 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Mizo is registered in the Family Intelligence System as Family Intelligence.' },
]
...
const PREDICTIONS = [
  ...
  ['Who is most likely to know everyone’s business without anyone telling them?', 'Happy'],
  ['Who is most likely to say “I told you so” before you even finish explaining?', 'Dina'],
  ['Who is most likely to turn a 2-minute story into a 20-minute story?', 'Kimo'],
  ['Who is most likely to start an argument over something completely insignificant?', 'Youssef'],
  ['Who is most likely to ask “What are we eating?” five minutes after eating?', 'Omariko'],
  ...
  ['Who is most likely to say “I know a shortcut” and make everyone late?', 'Rasha'],
  ...
  ['Who is most likely to say “I’m not hungry” and then eat everyone else’s food?', 'Spider'],
  ['Who is most likely to survive a zombie apocalypse?', 'Nolly'],
  ['Who is most likely to accidentally reveal a family secret?', 'Teefo'],
  ['Who is most likely to laugh at the worst possible moment?', 'Nina'],
  ['Who is most likely to turn a simple family decision into a committee meeting?', 'Aya'],
  ['Who is most likely to say “whatever you want” and then reject every option?', 'Sarah'],
  ['Who is most likely to take 47 photos and post none of them?', 'Reham'],
  ['Who is most likely to become famous?', 'Ella'],
  ['Who is most likely to negotiate their way out of trouble?', 'Malek'],
  ['Who is most likely to ask “Why?” 17 times in a row?', 'Omar'],
  ['Who is most likely to finish everyone’s snacks before anyone notices?', 'Zio'],
  ...
  ['Who is most likely to accidentally become the family group chat admin?', 'Mohamed'],
  ['Who is most likely to say “one more episode” and watch three?', 'Lilly'],
  ['Who is most likely to turn a small problem into a full engineering project?', 'Youssef'],
  ['Who is most likely to bring home something completely random and say “I thought we needed this”?', 'Nannoo'],
  ['Who is most likely to win an argument without actually answering the question?', 'Dina'],
  ['Who is most likely to have snacks hidden somewhere nobody knows about?', 'Bobba'],
  ['Who is most likely to arrive at a family gathering already knowing what everyone has been talking about?', 'Nehad'],
  ['Who would survive the longest on a deserted island?', 'Nolly'],
  ['Who would spend the most money in 10 minutes if given unlimited money?', 'Nannoo'],
  ['Who would be the worst person to share a hotel room with?', 'Kimo'],
  ['Who would be the best person to have in a zombie apocalypse?', 'Hany'],
  ['Who would forget their own birthday?', 'Youssef'],
  ['Who would become a millionaire first?', 'Dina'],
  ['Who would be most likely to join a reality TV show?', 'Happy'],
  ['Who would survive the longest without their phone?', 'Bobba'],
  ['Who would be most likely to accidentally send a message to the wrong family group?', 'Mido'],
  ['Who would be most likely to eat dessert before dinner?', 'Omar'],
  ['Who would be most likely to become a professional athlete?', 'Teefo'],
  ['Who would be most likely to become a YouTuber?', 'Nina'],
  ['Who would be most likely to win a family dance competition?', 'Maya'],
  ['Who would be most likely to become an astronaut?', 'Malek'],
  ['Who would be most likely to solve a murder mystery?', 'Reham'],
  ['Who would be most likely to get lost using Google Maps?', 'Spider'],
  ['Who would be most likely to start a business?', 'Kimo'],
  ['Who would be most likely to forget why they walked into a room?', 'Nehad'],
          ...
          <div className="mb-7 flex flex-wrap items-end justify-between gap-5">
            <div>
              ...
              <h1 className="text-4xl font-black tracking-[-0.04em] text-white md:text-6xl">
                {screen === 'wall' && <>Meet the <span className="text-brand-400">subjects.</span></>}
