...
const FAMILY = [
  ...
  { id: 'dina', name: 'Dina', role: 'Family Sports Expert', initials: 'D', color: 'from-violet-500/30 to-violet-950', stats: { intelligence: 97, chaos: 48, dadEnergy: 88, snackDetection: 91 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Dina is registered in the Family Intelligence System as Family Sports Expert.' },
  { id: 'omar', name: 'Omar', role: 'Junior Sweet Tooth', initials: 'O', color: 'from-sky-500/30 to-sky-950', stats: { intelligence: 96, chaos: 97, dadEnergy: 52, snackDetection: 100 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Omar is registered in the Family Intelligence System as Junior Sweet Tooth.' },
  ...
  { id: 'silvia', name: 'Silvia', role: 'Family Traveller', initials: 'S', color: 'from-pink-500/30 to-pink-950', stats: { intelligence: 87, chaos: 87, dadEnergy: 89, snackDetection: 97 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Silvia is registered in the Family Intelligence System as Family Traveller.' },
  { id: 'happy', name: 'Happy', role: 'Family Expert Banker', initials: 'H', color: 'from-cyan-500/30 to-cyan-950', stats: { intelligence: 94, chaos: 39, dadEnergy: 100, snackDetection: 78 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Happy is registered in the Family Intelligence System as Family Expert Banker.' },
  { id: 'hany', name: 'Hany', role: 'Family Ferarri Driver', initials: 'H', color: 'from-fuchsia-500/30 to-fuchsia-950', stats: { intelligence: 80, chaos: 52, dadEnergy: 55, snackDetection: 95 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Hany is registered in the Family Intelligence System as Family Ferarri Driver.' },
  { id: 'teefo', name: 'Teefo', role: 'Family Expert Cuber', initials: 'T', color: 'from-orange-500/30 to-orange-950', stats: { intelligence: 87, chaos: 65, dadEnergy: 66, snackDetection: 76 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Teefo is registered in the Family Intelligence System as Family Expert Cuber.' },
  { id: 'nina', name: 'Nina', role: 'Family Junior Teaser', initials: 'N', color: 'from-indigo-500/30 to-indigo-950', stats: { intelligence: 94, chaos: 78, dadEnergy: 77, snackDetection: 93 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Nina is registered in the Family Intelligence System as Family Junior Teaser.' },
  { id: 'nehad', name: 'Nehad', role: 'Family Godmother', initials: 'N', color: 'from-teal-500/30 to-teal-950', stats: { intelligence: 80, chaos: 91, dadEnergy: 88, snackDetection: 74 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Nehad is registered in the Family Intelligence System as Family Godmother.' },
  { id: 'nannoo', name: 'Nannoo', role: 'Family Events Manager', initials: 'N', color: 'from-emerald-500/30 to-emerald-950', stats: { intelligence: 87, chaos: 43, dadEnergy: 99, snackDetection: 91 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Nannoo is registered in the Family Intelligence System as Family Events Manager.' },
  { id: 'omar-cousin', name: 'Omar', role: 'Executive World Creator', initials: 'O', color: 'from-violet-500/30 to-violet-950', stats: { intelligence: 94, chaos: 56, dadEnergy: 54, snackDetection: 72 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Omar is registered in the Family Intelligence System as Executive World Creator.' },
  { id: 'bobba', name: 'Bobba', role: 'Positive Energy Supplier', initials: 'B', color: 'from-sky-500/30 to-sky-950', stats: { intelligence: 80, chaos: 69, dadEnergy: 65, snackDetection: 89 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Bobba is registered in the Family Intelligence System as Positive Energy Supplier.' },
  { id: 'rasha', name: 'Rasha', role: 'Family Magnet', initials: 'R', color: 'from-amber-500/30 to-amber-950', stats: { intelligence: 87, chaos: 82, dadEnergy: 76, snackDetection: 70 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Rasha is registered in the Family Intelligence System as Family Magnet.' },
  { id: 'spider', name: 'Spider', role: 'DJ/Photographer', initials: 'S', color: 'from-pink-500/30 to-pink-950', stats: { intelligence: 94, chaos: 95, dadEnergy: 87, snackDetection: 87 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Spider is registered in the Family Intelligence System as DJ/Photographer.' },
  { id: 'reham', name: 'Reham', role: 'Creative Writer', initials: 'R', color: 'from-cyan-500/30 to-cyan-950', stats: { intelligence: 80, chaos: 47, dadEnergy: 98, snackDetection: 68 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Reham is registered in the Family Intelligence System as Creative Writer.' },
  { id: 'ramy', name: 'Ramy', role: 'Business Consultant', initials: 'R', color: 'from-fuchsia-500/30 to-fuchsia-950', stats: { intelligence: 87, chaos: 60, dadEnergy: 53, snackDetection: 85 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Ramy is registered in the Family Intelligence System as Business Consultant.' },
  { id: 'ella', name: 'Ella', role: 'Junior Dancer', initials: 'E', color: 'from-orange-500/30 to-orange-950', stats: { intelligence: 94, chaos: 73, dadEnergy: 64, snackDetection: 66 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Ella is registered in the Family Intelligence System as Junior Dancer.' },
  { id: 'mia', name: 'Mia', role: 'Junior Cook', initials: 'M', color: 'from-indigo-500/30 to-indigo-950', stats: { intelligence: 80, chaos: 86, dadEnergy: 75, snackDetection: 83 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Mia is registered in the Family Intelligence System as Junior Cook.' },
  { id: 'lilly', name: 'Lilly', role: 'Family Expat', initials: 'L', color: 'from-teal-500/30 to-teal-950', stats: { intelligence: 87, chaos: 38, dadEnergy: 86, snackDetection: 100 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Lilly is registered in the Family Intelligence System as Family Expat.' },
  { id: 'zio', name: 'Zio', role: 'Junior Gamer', initials: 'Z', color: 'from-emerald-500/30 to-emerald-950', stats: { intelligence: 94, chaos: 51, dadEnergy: 97, snackDetection: 81 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Zio is registered in the Family Intelligence System as Junior Gamer.' },
  { id: 'kimo', name: 'Kimo', role: 'Superior Family Intelligence', initials: 'K', color: 'from-violet-500/30 to-violet-950', stats: { intelligence: 80, chaos: 64, dadEnergy: 52, snackDetection: 98 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Kimo is registered in the Family Intelligence System as Superior Family Intelligence.' },
  { id: 'sarah', name: 'Sarah', role: 'Laughing Distributer', initials: 'S', color: 'from-sky-500/30 to-sky-950', stats: { intelligence: 87, chaos: 77, dadEnergy: 63, snackDetection: 79 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Sarah is registered in the Family Intelligence System as Laughing Distributer.' },
  { id: 'youssy', name: 'Youssy', role: 'World Capitals Expert', initials: 'Y', color: 'from-amber-500/30 to-amber-950', stats: { intelligence: 94, chaos: 90, dadEnergy: 74, snackDetection: 96 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Youssy is registered in the Family Intelligence System as World Capitals Expert.' },
  { id: 'malek', name: 'Malek', role: 'Prankster', initials: 'M', color: 'from-pink-500/30 to-pink-950', stats: { intelligence: 80, chaos: 42, dadEnergy: 85, snackDetection: 77 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Malek is registered in the Family Intelligence System as Prankster.' },
  ...
  { id: 'nolly', name: 'Nolly', role: 'Family Royal Queen', initials: 'N', color: 'from-fuchsia-500/30 to-fuchsia-950', stats: { intelligence: 94, chaos: 68, dadEnergy: 51, snackDetection: 75 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Nolly is registered in the Family Intelligence System as Family Royal Queen.' },
  { id: 'aya', name: 'Aya', role: 'Family Patience In a Bottle', initials: 'A', color: 'from-orange-500/30 to-orange-950', stats: { intelligence: 80, chaos: 81, dadEnergy: 62, snackDetection: 92 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Aya is registered in the Family Intelligence System as Family Patience In a Bottle.' },
  { id: 'mohamed', name: 'Mohamed', role: 'AI Manager', initials: 'M', color: 'from-indigo-500/30 to-indigo-950', stats: { intelligence: 87, chaos: 94, dadEnergy: 73, snackDetection: 73 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Mohamed is registered in the Family Intelligence System as AI Manager.' },
  { id: 'silo', name: 'Silo', role: 'Gymnaster', initials: 'S', color: 'from-teal-500/30 to-teal-950', stats: { intelligence: 94, chaos: 46, dadEnergy: 84, snackDetection: 90 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Silo is registered in the Family Intelligence System as Gymnaster.' },
  { id: 'maya', name: 'Maya', role: 'Junior YouTube Expert', initials: 'M', color: 'from-emerald-500/30 to-emerald-950', stats: { intelligence: 80, chaos: 59, dadEnergy: 95, snackDetection: 71 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Maya is registered in the Family Intelligence System as Junior YouTube Expert.' },
  { id: 'osos', name: 'Osos', role: 'Family Legal Advisor', initials: 'O', color: 'from-violet-500/30 to-violet-950', stats: { intelligence: 87, chaos: 72, dadEnergy: 50, snackDetection: 88 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Osos is registered in the Family Intelligence System as Family Legal Advisor.' },
  { id: 'mizo', name: 'Mizo', role: 'Egyptian Foreign Representative', initials: 'M', color: 'from-sky-500/30 to-sky-950', stats: { intelligence: 94, chaos: 85, dadEnergy: 61, snackDetection: 69 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Mizo is registered in the Family Intelligence System as Egyptian Foreign Representative.' },
  { id: 'saleh', name: 'saleh', role: 'Vape Expert', initials: 'M', color: 'from-sky-500/30 to-sky-950', stats: { intelligence: 94, chaos: 85, dadEnergy: 61, snackDetection: 69 }, traits: ['Family Friend', 'Personality Detected', 'Family System Online'], description: 'Saleh is registered in the Family Intelligence System as Vape Expert.' },
  { id: 'dodi', name: 'Dodi', role: 'Family Friend', initials: 'M', color: 'from-sky-500/30 to-sky-950', stats: { intelligence: 94, chaos: 85, dadEnergy: 61, snackDetection: 69 }, traits: ['Family Friend', 'Personality Detected', 'Family System Online'], description: 'Dodi is registered in the Family Intelligence System as Family Friend.' },
];
