...
const FAMILY = [
  ...
  { id: 'mido', name: 'Mido', role: 'Core Systems', initials: 'M', color: 'from-amber-500/30 to-amber-950', stats: { intelligence: 80, chaos: 74, dadEnergy: 78, snackDetection: 80 }, traits: ['Family Member', 'Personality Detected', 'Family System Online'], description: 'Mido is registered in the Family Intelligence System as Family Consultant.' },
...
const PREDICTIONS = [
  ...
  ['Who is most likely to take 47 photos and post none of them?', 'Youssef'],
  ['Who is most likely to become famous?', 'Rasha'],
  ...
  ['Who is most likely to arrive at a family gathering already knowing what everyone has been talking about?', 'Mizo'],
