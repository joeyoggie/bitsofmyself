...
const PREDICTIONS = [
  ['Who is most likely to eat the last piece of pizza?', 'Omar'],
  ['Who is most likely to fall asleep first?', 'Nehad'],
  ['Who is most likely to be late?', 'Yousser'],
  ['Who is most likely to buy something completely unnecessary?', 'Nannoo'],
  ['Who is most likely to know where everything is?', 'Grandma'],
  ['Who is most likely to say “I told you so”?', 'Dina'],
  ['Who is most likely to start an argument about the correct way to do something?', 'Kimo'],
  ['Who is most likely to turn a simple question into 17 more questions?', 'Omar'],
]
